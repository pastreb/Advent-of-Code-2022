    ...
    */
    ...
    public static int solve_part_1(List<String> input) {
        ...
        for(String round : input) {
            String me = round.substring(2,3);
            if(me.equals("X")) { // I choose Rock
                points += 1;
            } else if(me.equals("Y")) { // I choose Paper
                points += 2;
            } else if(me.equals("Z")) { // I choose Scissors
                points += 3;
            }
            if(round.equals("A Y") || round.equals("B Z") || round.equals("C X")) { // I win
                points += 6;
            } else if(round.equals("A X") || round.equals("B Y") || round.equals("C Z")) { // We draw
                points += 3;
            }
        }        
        return points;
    ...
    */
    ...
    public static int solve_part_2(List<String> input) {
        ...
        for(String round : input) {
            ...
            String me = round.substring(2,3);
            if(me.equals("Z")) { // I should win
                points += 6;
                if(opponent.equals("A")) { // Opponent chooses Rock
                    points += 2; // I choose Paper
                } else if(opponent.equals("B")) { // Opponent chooses Paper
                    points += 3; // I choose Scissors
                } else if(opponent.equals("C")) { // Opponent chooses Scissors
                    points += 1; // I choose Rock
                }
            } else if(me.equals("Y")) { // We should draw
                points += 3;
                if(opponent.equals("A")) { // Opponent chooses Rock
                    points += 1; // I choose Rock
                } else if(opponent.equals("B")) { // Opponent chooses Paper
            ...
            } else if(me.equals("X")) { // I should lose
                if(opponent.equals("A")) { // Opponent chooses Rock
                    points += 3; // I choose Scissors
                } else if(opponent.equals("B")) { // Opponent chooses Paper
                    points += 1; // I choose Rock
