...
public class CathodeRayTube {
    ...
    */
    ...
    public static int solve_part_1(List<String> input) {
        ...
        int X = 1;
        int cycle = 0;
        int next_output_cycle = 20;
        for(String line : input) {
            if(line.equals("noop")) {
                cycle++;
                if(cycle == next_output_cycle && cycle <= 220) {
                    System.out.println("Cycle " + cycle + ": " + cycle*X);
                    sum += cycle * X;
    ...
    */
    ...
    public static void solve_part_2(List<String> input) {
        int i = 0;
        int X = 1;
        for(String line : input) {
            if(line.equals("noop")) {
                System.out.print((i == X-1 || i == X || i == X+1)? "#" : ".");
                i++;
                if(i == 40) {
                    System.out.println();
                    i = 0;
